[![Run App JadeRomero](https://github.com/jaderomero/CILab/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jaderomero/CILab/actions/workflows/run-app.yaml)
